...
createRoot(document.getElementById("root")!).render(
  <div style={representativeHostTheme}>
    <WorkshopToolView requestWorkspaceRoot={() => undefined} browseWorkspaceRoot={() => ({ ok: true, root: "/preview/slate" })} browseMarkdownFile={(currentPath) => ({ ok: true, path: currentPath ? currentPath.replace(/\.md$/, "-selected.md") : "/preview/selected-document.md" })} />
  </div>,
);
